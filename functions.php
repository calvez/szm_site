...
define("THEMENAME", "Artemis");
define("SHORTNAME", "pp");
define("SKINSHORTNAME", "ps");
define("THEMEVERSION", "1.7.1");
define("THEMEDOMAIN", THEMENAME.'Language');
define("DEFAULT_FONT", 'Dosis');
define("THEMEDEMOURL", 'http://themes.themegoods.com/artemis_wp');
...
if ( function_exists( 'add_image_size' ) ) {
	...
	add_image_size( 'blog', 816, 408, true );
}
...
if(!empty($pp_font))
{
	wp_enqueue_style('google_fonts', "http://fonts.googleapis.com/css?family=".$pp_font."&subset=latin,latin-ext", false, "", "all");
}
